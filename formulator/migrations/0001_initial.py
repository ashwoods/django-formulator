# -*- coding: utf-8 -*-
# Generated by Django 1.9.1 on 2016-02-02 04:48
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('key', models.CharField(max_length=100)),
                ('value', models.CharField(blank=True, max_length=100)),
                ('field', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='formulator.Field')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('form_id', autoslug.fields.AutoSlugField(editable=False, populate_from='name')),
        ...
        migrations.AddField(
            model_name='fieldset',
            name='form',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='formulator.Form'),
        ),
        migrations.AddField(
            model_name='field',
            name='fieldset',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='formulator.FieldSet'),
        ),
        migrations.AddField(
            model_name='field',
            name='form',
        ...
        migrations.AlterUniqueTogether(
            name='fieldset',
            unique_together=set([('form', 'position')]),
        ),
        migrations.AlterUniqueTogether(
            name='field',
            unique_together=set([('form', 'position')]),
